...
namespace Tests\solutionDrive\SyliusBackendSecurityThroughObscurityPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\solutionDrive\SyliusBackendSecurityThroughObscurityPlugin\Behat\Page\Shop\WelcomePageInterface;
